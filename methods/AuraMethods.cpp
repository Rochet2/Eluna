...
namespace LuaAura
{
    ...
    */
    ...
    {
        Aura* aura = Eluna::CHECKOBJ<Aura>(L, 1);
    ...
    */
    int GetCasterLevel(lua_State* L)
    {
        Aura* aura = Eluna::CHECKOBJ<Aura>(L, 1);
    ...
    */
    int GetMaxDuration(lua_State* L)
    {
        Aura* aura = Eluna::CHECKOBJ<Aura>(L, 1);
#ifndef TRINITY
    ...
    */
    int GetStackAmount(lua_State* L)
    {
        Aura* aura = Eluna::CHECKOBJ<Aura>(L, 1);
    ...
    */
    int SetMaxDuration(lua_State* L)
    {
        Aura* aura = Eluna::CHECKOBJ<Aura>(L, 1);
        int32 duration = Eluna::CHECKVAL<int32>(L, 2);
#ifndef TRINITY
    ...
    * @param uint32 amount
    */
    int SetStackAmount(lua_State* L)
    {
        Aura* aura = Eluna::CHECKOBJ<Aura>(L, 1);
...
static ElunaFunction AuraMethods[] =
{
...
ELUNA_TYPE(Aura, false, AuraMethods, "ElunaBase")

void RegisterTypeAura(Eluna* E)
{
    ElunaTemplate<Aura>::RegisterTypeForState(E);
}
